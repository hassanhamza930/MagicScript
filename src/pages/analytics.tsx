...
function Analytics() {
    ...
    const [salesScript, setsalesScript] = useState<Array<ScriptLine>>(
        [
            {
                text:"Cold Calling, is Science"
            },
            {
                text:"We're working very hard, on bringing you tools that will help you systematically improve your cold calls, and gain deep insights on where your customers are dropping off, what are the most common objections and much more."
            },
            {
                text:"We'll notify you, via email once our Analytics tool is live!"
            },
        ] as Array<ScriptLine>
        );
